    ...
    <div class="row">
            ...
            <div class="card mb-3 shadow-sm">
              <div class="row g-0">
                ...
                <div class="col-md-3 d-flex align-items-center justify-content-center">
                  <div class="btn-group">
                    <asp:Button runat="server" CssClass="btn btn-outline-secondary" Text="–" CommandName="Disminuir" CommandArgument='<%# Eval("idItemCarrito") %>' />
                    <asp:Label ID="lblCantidad" runat="server" Text='<%# Eval("cantidad") %>' CssClass="mx-2 align-self-center" />
                    <asp:Button runat="server" CssClass="btn btn-outline-secondary" Text="+" CommandName="Aumentar" CommandArgument='<%# Eval("idItemCarrito") %>' />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm p-4">
          ...
          <p><strong>Subtotal:</strong> S/ <asp:Label ID="lblSubtotal" runat="server" /></p>
          <p><strong>IGV (18%):</strong> S/ <asp:Label ID="lblIGV" runat="server" /></p>
          <p><strong>Total:</strong> S/ <asp:Label ID="lblTotal" runat="server" CssClass="fw-bold" /></p>
          <hr />
