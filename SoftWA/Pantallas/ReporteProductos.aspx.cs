...
namespace SoftWA.Pantallas
{
    public partial class ReporteProductos : System.Web.UI.Page
    {
        ...
        private void LoadProductData()
        {
            ...
            dt.Rows.Add("111", "Cuchillo Picado", "Cuchillos", 50, 60.00m, 3000.00m);
            dt.Rows.Add("112", "Cuchillo Tramontina", "Cuchillos", 30, 80.00m, 2400.00m);
            dt.Rows.Add("113", "Helado para hornear", "Repostería", 40, 100.00m, 4000.00m);
            dt.Rows.Add("114", "Olla de sueño", "Ollas", 20, 300.00m, 6000.00m);
